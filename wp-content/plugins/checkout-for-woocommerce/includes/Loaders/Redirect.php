...
class Redirect extends Loader {
	...
	public static function checkout() {
		...
		if ( apply_filters( 'cfw_load_checkout_template', Main::is_checkout() ) ) {
			...
			$css_classes = apply_filters( 'body_class', array( 'checkout-wc', 'woocommerce', 'woocommerce-checkout', cfw_get_main()->get_templates_manager()->get_active_template()->get_slug() ), array() );
	...
	public static function order_pay() {
		...
		if ( apply_filters( 'cfw_load_order_pay_template', Main::is_checkout_pay_page() ) ) {
			...
			$css_classes = array( 'checkout-wc', 'woocommerce', 'woocommerce-checkout', cfw_get_main()->get_templates_manager()->get_active_template()->get_slug() );
	...
	public static function order_received() {
		...
		if ( apply_filters( 'cfw_load_order_received_template', Main::is_order_received_page() ) ) {
			...
			$css_classes = array( 'checkout-wc', 'woocommerce', cfw_get_main()->get_templates_manager()->get_active_template()->get_slug() );
	...
	public static function head( array $classes ) {
		...
		if ( has_action( 'cfw_custom_header' ) ) {
			...
			cfw_get_main()->get_templates_manager()->get_active_template()->view( 'header.php' );
		}
	...
	public static function footer() {
		...
		if ( has_action( 'cfw_custom_footer' ) ) {
			...
			cfw_get_main()->get_templates_manager()->get_active_template()->view( 'footer.php' );
		}
