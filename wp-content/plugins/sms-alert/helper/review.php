<?php
	...
	class WCReview
	{
		...
		public static function getReviewTemplates()
		{
			...
			$text_body                  = smsalert_get_option('customer_notify', 'smsalert_or_message', sprintf(__('Hi %s, thank you for your recent order on %s. Can you take 1 minute to leave a review about your experience with us? %s.','sms-alert'), '[first_name]', '[store_name]', 'https://www.google.com/search?q=[shop_url]'));
