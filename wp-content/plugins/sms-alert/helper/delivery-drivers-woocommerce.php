...
class smsalert_delivery_drivers_woocommerce
{
	...
	public static function getDeliverDriversTemplates()
	{
		...
		$text_body 			= smsalert_get_option('driver_notify', 'smsalert_driver_message', sprintf(__('Hi %s %s , The package for order %s Products %s %s has been ready to pickup from %s.','sms-alert'), '[first_name]', '[last_name]', '[order_id]', '[item_name]', '[item_name_qty]', '[store_name]'));
