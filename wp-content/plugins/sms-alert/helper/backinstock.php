...
class sa_backinstock
{
	...
	public static function getBackInStockTemplates()
	{
		...
		$text_body 		= smsalert_get_option('customer_bis_notify', 'smsalert_bis_message', sprintf(__('Hello, %s is now available, you can order it on %s.','sms-alert'), '[item_name]', '[shop_url]'));
		...
		$text_body 		= smsalert_get_option('subscribed_bis_notify', 'smsalert_bis_message', sprintf(__('We have noted your request and we will notify you as soon as %s is available for order with us.','sms-alert'), '[item_name]'));
