...
class NewUserApprove
{
	...
	{	
		...
		$text_body 			= smsalert_get_option( 'approved_notify', 'smsalert_nua_message', sprintf(__('Dear %s, your account with %s has been approved.','sms-alert'), '[username]','[store_name]'));
		...
		$text_body 			= smsalert_get_option('denied_notify', 'smsalert_nua_message', sprintf(__('Dear %s, your account with %s has been rejected.','sms-alert'), '[username]','[store_name]'));
