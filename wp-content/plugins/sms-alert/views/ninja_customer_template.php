			...
			<table class="form-table">
				...
				<tr valign="top">
					<td>
						...
						<textarea data-parent_id="smsalert_ninja_general[ninja_message_<?php echo $vs; ?>]" name="smsalert_ninja_message[ninja_sms_body_<?php echo $vs; ?>]" id="smsalert_ninja_message[ninja_sms_body_<?php echo $vs; ?>]" <?php echo((smsalert_get_option( 'ninja_order_status_'.$vs, 'smsalert_ninja_general', 'on')=='on')?'' : "readonly='readonly'"); ?>><?php echo smsalert_get_option('ninja_sms_body_'.$vs, 'smsalert_ninja_message', sprintf(__('Hello %s, Thank you for contacting us.','sms-alert'), '[name]')); ?></textarea>
					</td>
				</tr>
				<tr>
					<td>
