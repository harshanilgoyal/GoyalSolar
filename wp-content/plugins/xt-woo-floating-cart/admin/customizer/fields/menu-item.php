...
if ( $this->core->access_manager()->can_use_premium_code__premium_only() ) {
	...
	$fields[] = array(
		...
		'js_vars'     => array(
			array(
				'element'  => '.xt_woofc-menu.xt_woofc-is-desktop',
				'function' => 'class',
	...
	$fields[] = array(
		...
		'js_vars'     => array(
			array(
				'element'  => '.xt_woofc-menu.xt_woofc-is-tablet',
				'function' => 'class',
	...
	$fields[] = array(
		...
		'js_vars'     => array(
			array(
				'element'  => '.xt_woofc-menu.xt_woofc-is-mobile',
				'function' => 'class',
	...
	$fields[] = array(
		...
		'partial_refresh'    => [
			'cart_menu_display' => [
				'selector'        => 'a.xt_woofc-menu-link',
				'render_callback' => function() {
					return $this->core->frontend()->menu->cart_menu_link();
				},
			]
		],
		'active_callback' => array(
