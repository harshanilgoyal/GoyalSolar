            ...
            <div id="xt-license-activation-<?php echo esc_attr( $this->market_product()->id ); ?>"
                ...
                <div id="xt-license-activation-form"
                    ...
                    <input type="hidden" name="wpnonce"
                           value="<?php echo wp_create_nonce( $this->prefix( 'activation' ) ); ?>">
                    <input type="hidden" name="domain" value="">
                    <input type="hidden" name="installation_url" value="">
                    <input type="hidden" name="product_id"
                           value="<?php echo esc_attr( $this->market_product()->id ); ?>">
                    <input class="regular-text" placeholder="<?php echo $license_key_label; ?>..." name="purchase_code"
                           value="">
                    <a href="<?php echo $this->market_product()->url; ?>" class="button"
                       target="_blank"><?php echo esc_html__( 'Buy License', 'xt-framework' ); ?></a>
                    <input type="submit" class="button button-primary"
                           value="<?php echo esc_html__( 'Validate', 'xt-framework' ); ?>">
                </div>
                ...
                <div id="xt-license-revoke-form" class="xt-license-form xt-license-hide">
                    ...
                    <input type="hidden" name="wpnonce"
                           value="<?php echo wp_create_nonce( $this->prefix( 'revoke' ) ); ?>">
                    <input type="hidden" name="purchase_code" value="">
                    <input type="hidden" name="domain" value="">
                    <input type="button" class="button button xt-license-revoke-cancel"
                           value="<?php echo esc_html__( 'Cancel', 'xt-framework' ); ?>">

                    <a href="<?php echo $this->market_product()->url; ?>" class="button"
                       target="_blank"><?php echo esc_html__( 'Buy License', 'xt-framework' ); ?></a>
                    <input type="submit" class="button button-primary"
                           value="<?php echo esc_html__( 'Revoke', 'xt-framework' ); ?>">
                </div>
                ...
                <div id="xt-license-local-revoke-form"
                    ...
                    <input type="hidden" name="purchase_code"
                           value="<?php echo $this->getLocalLicenseInfo( 'purchase_code' ); ?>">
                    <input type="hidden" name="domain" value="<?php echo $this->getLocalLicenseInfo( 'domain' ); ?>">
                    <input type="hidden" name="local" value="1">
                    <a href="<?php echo $this->market_product()->url; ?>" class="button"
                       target="_blank"><?php echo esc_html__( 'Buy License', 'xt-framework' ); ?></a>
                    <input type="submit" class="button button-primary"
                           value="<?php echo esc_html__( 'Revoke License', 'xt-framework' ); ?>">
                </div>
            </div>
