        ...
        <?php foreach ( WC()->cart->get_coupons() as $code => $coupon ): ?>
            <div class="xt_woofc-coupon-item">
                <div class="xt_woofc-coupon-item-inner">
                    <span class="xt_woofc-coupon-code"><?php echo $code; ?></span>
                    ...
                    <a href="#" class="xt_woofc-remove-coupon" data-coupon="<?php echo $code ?>"><?php _e( '[Remove]', 'woo-floating-cart' ) ?></a>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
...
foreach (  xt_woo_floating_cart()->frontend()->get_coupons() as $section => $coupons ){
    ...
    foreach ( $coupons as $coupon_data ) {
        ...
        <div class="xt_woofc-coupon-item">
            <div class="xt_woofc-coupon-item-inner">
                <span class="xt_woofc-coupon-code"><?php echo $coupon->get_code(); ?></span>
                ...
                <?php if(!empty($coupon->get_description())): ?>
                    <span class="xt_woofc-coupon-desc"><?php echo $coupon->get_description() ?></span>
                <?php endif; ?>
                <?php if( $section === 'valid' ): ?>
                    <a href="#" class="xt_woofc-coupon-apply button" data-coupon="<?php echo $coupon->get_code() ?>"><?php _e( 'Apply Coupon', 'woo-floating-cart' ); ?></a>
                <?php endif; ?>
            </div>
        </div>
        <?php
